...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Car car3 = new Car("Ford", "Muntang", 2023, "HIJK8973", 1000, true);
        ...
        // Create Customer
        Customer customer = new Customer("Rohit", "9026780629", "DL1234");
        ...
        if(!availableCars.isEmpty()) {
            ...
            System.out.println("No car is available with given specification");
        }
    }
}
